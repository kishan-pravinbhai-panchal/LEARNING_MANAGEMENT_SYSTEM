...
const CourseSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <Link to={'/course-list'} onClick={()=>scrollTo(0,0)} className='text-gray-500 border border-gray-500/30 px-10 py-3 rounded hover:bg-blue-600 hover:text-white'>show all courses</Link>
    </div>
  )
}
